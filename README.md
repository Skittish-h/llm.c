## NOTE:
Below is the original README.md of llm.c that we forked for the applied GPU programming course at KTH, our readme can be found [here](/infer_related_scripts/README.md)
